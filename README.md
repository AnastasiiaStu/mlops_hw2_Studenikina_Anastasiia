...
Выполняла в основном в bash строке в VS Code.
...
New-Item server/__init__.py, client/__init__.py,
generated/__init__.py -ItemType File
...
Далее пришлось создать и активировать виртуальное окружение, тк VS Code
глючил (или я глючила)- VS Code в bash строке горел красным и не
запускался.

Дальше все работало -- ОК.
...
## 6) Запустила докер и открыла второй терминал в нем:
